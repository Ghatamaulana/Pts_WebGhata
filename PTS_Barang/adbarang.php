...
if (isset($_POST['submitt'])) {
    if ( tambah_barang($_POST) > 0 ) {
        echo "<script>alert('Data Barang Berhasil Di Tambah!');
               document.location.href = 'listbarang.php';
              </script>";
    } else {
        echo "<script>alert('Data Barang Gagal Di Tambah!');
               document.location.href = 'listbarang.php';
              </script>";
    }
}
  ...
  <body>
    ...
    <div class="container mt-5">
        ...
        <form class="" method="post">
            ...
            <button type="submit" name="submitt" class="btn btn-primary" style="float: right;">Submit</button>
        </form>
    </div>
