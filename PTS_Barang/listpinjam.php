  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <a href="adpinjam.php" class="btn btn-outline-success my-1 my-sm-0">Add</a>
    ...
    <h4 class="text-center">List Peminjaman</h4>
    </div>
      ...
      <table class="table table-striped table-bordered table-sm text-center">
        ...
        <?php $no = 1;?>
          ...
          <tr>
              ...
              <td width="15%">
              <a href="editp.php?id_pinjam=<?= $pinjam['id_pinjam']; ?>" class='btn btn-success'>Edit</a>
              <a href="delp.php?id_pinjam=<?= $pinjam ['id_pinjam']; ?>" class='btn btn-danger' onclick="return confirm('Yakin Data Barang Akan Di Hapus ?')">Hapus</a>
              </td>
          </tr>
          <?php endforeach;?>
        </tbody>
